...
// Two sortable tables shared across the participation drill-down:
// geo-level and department-level. Each takes typed rows + click-to-
// sort behavior. Default sort is alphabetical by name — the
...
// and an extracted-generic version was harder to read than two
// small specific ones.
